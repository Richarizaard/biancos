namespace :toppings do
    task populate: :environment do
        toppings = {
            ...
            "garlic": "Bianco's Pizza With the Great Taste of Garlic.",
            ...
            "jalapeno peppers": "Jalapeños peppers perk up any Bianco's pizza. They also add spice to our Oven Baked Sandwiches.",
